...
# Functions for running Helloworld 
cd com.mde-network.ep.toolfunctions.helloworldfunction
mvn -B -o function:run -Drun.functionTarget=com.mdenetnetwork.ep.toolfunctions.helloworldfunction.RunHelloWorldFunction -Drun.port=8001 &
